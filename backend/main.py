...
async def generate_letter(request: LoveLetterRequest):
    ...
    try:
        ...
        prompt = f"Write a {request.tone} love letter to {request.recipient_name or 'your beloved'} in no more than 5 sentences, based on their interests: {request.preferences or 'romantic moments'}. Language: {language}."
        response = openai.ChatCompletion.create(
            model="gpt-4",
            messages=[{"role": "system", "content": "You are a romantic poet."},
